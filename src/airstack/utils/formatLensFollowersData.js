...
function formatLensFollowersData(followers, existingUser) {
    ...
    var _loop_1 = function (follower) {
        ...
        var following = Boolean((_b = (_a = follower === null || follower === void 0 ? void 0 : follower.mutualFollower) === null || _a === void 0 ? void 0 : _a.Following) === null || _b === void 0 ? void 0 : _b.length);
...
exports.default = formatLensFollowersData;
