...
function formatFarcasterFollowingsData(followings, existingUser) {
    ...
    var _loop_1 = function (following) {
        ...
        if (existingUserIndex !== -1) {
            ...
            recommendedUsers[existingUserIndex] = __assign(__assign(__assign({}, following), recommendedUsers[existingUserIndex]), { follows: __assign(__assign({}, follows), { followingOnFarcaster: true, followedOnFarcaster: followsBack }) });
        }
        else {
...
exports.default = formatFarcasterFollowingsData;
