...
var formatTokenSentData_1 = require("../utils/formatTokenSentData");
...
var fetchTokenSent = function (address, existingUsers, query) {
    if (existingUsers === void 0) { existingUsers = []; }
    if (query === void 0) { query = tokenSentQuery; }
        ...
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 3:
                    ...
                    recommendedUsers = __spreadArray([], (0, formatTokenSentData_1.default)(tokenTransfer, recommendedUsers), true); // Add type assertion here
...
exports.default = fetchTokenSent;
